<template>
  <div>
    ...
    <p>
      <strong>1. Art der Wertung</strong><br />
      Streckenflugwettbewerb mit Einzelwertung und Teamwertung, Vereinswertung,
      Sonderwertung, Rheinland-Pfalz Pokal
    </p>
    <p>
    ...
    <p>
      <strong>Mindestpunktzahl</strong> <br />60 Punkte - T-shirt 2 x 60 Punkte!
    </p>
    <p>
    ...
    <p>
      <strong>7. Einzelwertung</strong><br />
    ...
    <ul>
      ...
      <li>
        ...
        Klasse Intermediate High: Schirme EN C mit einer Streckung von >6,4
      </li>
      <li>
    ...
    <p>
      <strong>21. Luftrechtliche Bestimmungen</strong><br />
    ...
    <p>
      ...
      Ansprüche gegenüber dem Veranstalter, dem Ausrichter, dem Organisator, dem
      Wettbewerbsleiter sowie deren Helfer wegen einfacher Fahrlässigkeit sind
      ausgeschlossen.
    </p>
